...
const HIGHLIGHTS = [
  ...
  { title: '定向推荐', detail: '店员会根据人数和喜好，帮你挑最适合的游戏，不用自己纠结选什么' },
];
...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === '/api/generate') {
      ...
      const apiKey = env.DEEPSEEK_API_KEY || 'sk-2eb6feee768540b0925e520d619c898d';
      ...
      try {
        ...
        return json({ success: false, error: '请求失败，请重试' }, 500);
      }
    }
